...
try {
const res = await fetch(`${FB_URL}/cafeshift/${key}.json`);
...
try {
await fetch(`${FB_URL}/cafeshift/${key}.json`, {
method: “PUT”,
...
try {
const es = new EventSource(`${FB_URL}/cafeshift/${key}.json`);
...
setAbsences, setChangeReqs, setExtReqs, setSubReqs } = ctx;
